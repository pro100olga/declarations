...
decl_list = pd.read_csv("E:/personal/declarations/declarations_for_bi.csv", sep = ",", encoding = "utf8")
...
# d.to_csv("E:/personal/declarations/liabilities_flag.csv", sep = "|", encoding = "utf8")    
